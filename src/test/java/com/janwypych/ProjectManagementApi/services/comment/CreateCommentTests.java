...
public class CreateCommentTests extends BaseTestComment {
    ...
    public void shouldThrowProjectMemberNotFoundException() {
        ...
        when(projectMemberRepository.findByWorkspaceMemberAndProject(workspaceMember, project))
                .thenReturn(Optional.empty());
    ...
    @Test
    public void shouldCreateCommentWhenTaskExists() {
        when(workspaceMemberRepository.findByWorkspaceIdAndUser(workspace.getId(), user))
                .thenReturn(Optional.of(workspaceMember));
        ...
        assertEquals(createCommentRequest.getContent(), savedComment.getContent());
        assertEquals(task, savedComment.getTask());
        assertEquals(projectMember, savedComment.getAuthor());
    }
}
