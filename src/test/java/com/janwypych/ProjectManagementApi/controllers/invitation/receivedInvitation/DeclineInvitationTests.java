...
public class DeclineInvitationTests extends BaseTestReceivedInvitation {
    ...
    private void performPost(Long invitationId, ResultMatcher... matchers) throws Exception {
        var result = mockMvc.perform(
                MockMvcRequestBuilders.post("/api/v1/receivedInvitations/{invitationId}/decline", invitationId)
    ...
    public void shouldReturnHttp401WhenUserIsUnauthenticated() throws Exception {
        mockMvc.perform(
                        MockMvcRequestBuilders.post("/api/v1/receivedInvitations/1/decline"))
                .andExpect(
